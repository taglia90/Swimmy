<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Swimmy._Default" %>
            ...
            <header>
                ...
                <section id="login">
                    <asp:LoginView runat="server" ViewStateMode="Disabled">
                        <AnonymousTemplate>
                            <ul>
                                <li><a id="registerLink" runat="server" class="button circled scrolly" href="~/Account/Register">Esegui registrazione</a></li>
                                <br />
                                <li><a id="loginLink" runat="server" class="button circled scrolly" href="~/Account/Login">Accedi</a></li>
                            </ul>
                        </AnonymousTemplate>
                        <LoggedInTemplate>
                            <p>
